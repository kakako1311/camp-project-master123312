...
const activities = [
	{
		...
		url: 'https://www.facebook.com/aplusplus.coding'
	},
	{
		title: '亞洲盃(快要)',
		description: '亞洲盃是一個台灣最大的遊戲業餘賽事之一。'
	}
]
const makeClass = (i) => (
	i % 2 === 0 ?
			...
			<div :class="makeClass(i)">
				<div class="w-full sm:w-1/2 relative h-64 sm:h-auto">
					<img alt="活動圖片" class="w-full object-cover absolute inset-0 object-center h-full"
					     loading="lazy" :src="activity.image ?? 'https://images.chinatimes.com/newsphoto/2021-06-20/656/20210620001484.jpg'"/>
				</div>
				<div
